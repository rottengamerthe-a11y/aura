...
const CRATES = {
  common: {
    ...
    drops: [
      ...
      { type: "item", id: "vault_key", chance: 0.1 },
      { type: "item", id: "health_vial", chance: 0.24 },
      { type: "item", id: "smoke_bomb", chance: 0.2 },
    ],
  },
  rare: {
    aura: [1700, 3400],
    xp: [280, 520],
    drops: [
      { type: "item", id: "coinflip_gloves", chance: 0.2 },
      { type: "item", id: "combat_manual", chance: 0.18 },
      { type: "item", id: "health_vial", chance: 0.28 },
      { type: "item", id: "smoke_bomb", chance: 0.24 },
  ...
  epic: {
    ...
    xp: [560, 1000],
    drops: [
      { type: "item", id: "guardian_core", chance: 0.24 },
      { type: "item", id: "combat_manual", chance: 0.2 },
      { type: "item", id: "coinflip_gloves", chance: 0.2 },
      { type: "item", id: "adrenaline_tonic", chance: 0.3 },
      { type: "item", id: "smoke_bomb", chance: 0.2 },
      { type: "crate", id: "legendary", chance: 0.12 },
    ],
  },
  legendary: {
    aura: [8000, 14000],
    xp: [1200, 2100],
    drops: [
      { type: "item", id: "guardian_core", chance: 0.34 },
      { type: "item", id: "combat_manual", chance: 0.34 },
      { type: "item", id: "lucky_charm", chance: 0.24 },
      { type: "item", id: "vault_key", chance: 0.24 },
      { type: "item", id: "coinflip_gloves", chance: 0.28 },
      { type: "item", id: "adrenaline_tonic", chance: 0.34 },
      { type: "item", id: "health_vial", chance: 0.3 },
    ],
  },
};
